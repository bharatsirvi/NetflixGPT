...
const VideoTitle = ({ title, overview, adult }) => {
  return (
    <div className="z-20 absolute inset-0 flex flex-col justify-center items-start px-12 text-white">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="bg-gray-700 bg-opacity-80 text-white text-md font-bold px-8 py-3 rounded-md hover:bg-opacity-60 transition cursor-pointer">
         ...
         {!adult && (
        <div className="absolute z-30 bottom-40 right-0 text-white px-4 py-3 flex items-center gap-2 pointer-events-auto">
          U/A 18+
        </div>
      )}
      </div>
